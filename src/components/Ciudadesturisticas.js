...
import "../styles/Ciudadesturisticas.css";
    ...
    <div className="home-container">
      ...
      <div className="main-content">
        <div className="hero-container">
          <img
            src="/images/Contacto/CiudadesTuristicas.jpeg"
            alt="Ciudades Turísticas"
            className="hero-image"
          />
          <div className="hero-overlay">
            <h2 className="hero-title">{t("titleCiudadesTuristicas")}</h2>
          </div>
        </div>
        <MigasdePan/>
      </div>
...
export default Ciudadesturisticas;
